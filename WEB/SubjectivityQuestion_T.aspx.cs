...
public partial class SubjectivityQuestion_T : System.Web.UI.Page
{
    ...
    private DataTable GetTreeViewData(int treeType)    //获取数据
    {
        ...
        //}
        string selectCommand = selectCommand = @"select id,question_title,keywords,aboutAge,aboutAgeBegin,aboutAgeEnd from hbh_Sub_Qes_T";
    ...
    {
        string url = "SubjectivityQuestionShow_T.aspx?";
