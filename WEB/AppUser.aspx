<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AppUser.aspx.cs" Inherits="AppUser" %>
        ...
        <table>
            <tr>
                <div >
                  ...
                  <div>
                  <label style="width:200;">用户名</label>
                     <asp:TextBox ID="txtAccount"  Width="400" ReadOnly="false" runat="server" class="form_input" MultiLine="false" Alignment="0"></asp:TextBox>
                  </div>
