<%@ page language="C#" autoeventwireup="true" inherits="Message, App_Web_tcrbxzfv" %>
            ...
            <tr>
                <div style="direction:ltr">
                   ...
                   <%-- <asp:DropDownList ID="ddlSubQuestion" runat="server" CssClass="form_select"  Width="270">
                    ...
                    </asp:DropDownList>--%><div><label style="width:200;">年龄段开始</label>
                     <asp:TextBox ID="txtAboutAgeBegin" Width="400"  ReadOnly="false" runat="server" class="form_input" MultiLine="false" Alignment="0"></asp:TextBox>
                  
                  </div>
                  <div>
                  <label style="width:200;">年龄段结束</label>
                     <asp:TextBox ID="txtAboutAgeEnd"  Width="400" ReadOnly="false" runat="server" class="form_input" MultiLine="false" Alignment="0"></asp:TextBox>
                  </div>
